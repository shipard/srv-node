 ...
 * Class WebApp
 */
class WebApp extends \lib\Application
{
	var $dsRoot;
	var $urlRoot;
	var $requestPath;
	...
	protected function cameraImage ()
	{
		...
		$imageResizer = new \lib\cameras\ImageResizer ($this);
		$imageResizer->run();
	...
	public function control ()
	{
		...
		$ce = new \lib\control\Control($this);
